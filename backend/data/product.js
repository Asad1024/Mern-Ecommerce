...
const products = [
  ...
  },
  {
    ...
    "description": "Flagship smartphone with 6.1-inch display and triple-camera system.",
    "brand": "Apple",
  ...
  //     "id": 6,
  //     "name": "Air Purifier",
  //     "description": "Efficient air purifier with HEPA filter for large rooms.",
  //     "brand": "Dyson",
  ...
  //     "description": "Powerful stand mixer for baking and cooking needs.",
  //     "brand": "KitchenAid",
  ...
  //     "description": "Compact and portable earbuds with noise cancellation.",
  //     "brand": "Bose",
  //     "category": "Audio",
  //     "price": 249.99,
  //     "countInStock": 70,
  ...
  //     "description": "1080p HD smart camera with motion detection and night vision.",
  //     "brand": "Ring",
